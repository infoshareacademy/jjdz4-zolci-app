...
<div class="container">
    <div class="content">
        ...
        <form class="form-group" method="post" action="vs-car-add">
            <label for="modelName"><fmt:message key="vehicleSearchSteps.model"/>
            </label><input class="form-control" id="modelName" type="text" name="modelName" required>

            <label for="year"><fmt:message key="vehicleSearchSteps.yearOfProduction"/>
            </label><input class="form-control" id="year" type="number" min="0" name="year" required>

            <label for="engineName"><fmt:message key="vehicleSearchSteps.engineType"/>
            </label><input class="form-control" id="engineName" type="text" name="engineName">

            <label for="hp"><fmt:message key="vehicleSearchSteps.power"/>
            </label><input class="form-control" id="hp" type="text" name="hp">

            <label for="ccm"><fmt:message key="vehicleSearchSteps.capacity"/>
            </label><input class="form-control" id="ccm" type="text" name="ccm">

            <label for="fuel"><fmt:message key="vehicleSearchSteps.fuelType"/>
            </label><input class="form-control" id="fuel" type="text" name="fuel">
